...
<html>
    <head>
        <title>Invoicer Web - Ropnop</title>
...
"source": "https://github.com/ropnop/invoicer",
"version": "%s",
"commit": "%s",
"build": "https://circleci.com/gh/ropnop/invoicer/"
}`, version, commit)))
}
